...
class TomcatPluginExtension {
    final static String DEFAULT_PROTOCOL_HANDLER = 'org.apache.coyote.http11.Http11Nio2Protocol'
    final static String DEFAULT_AJP_PROTOCOL_HANDLER = 'org.apache.coyote.ajp.AjpNio2Protocol'
